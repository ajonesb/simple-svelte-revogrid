...
// node_modules/@revolist/revogrid/dist/esm/text-editor-DlCRmV75.js
...
// node_modules/@revolist/revogrid/dist/esm/revogr-clipboard_3.entry.js
var Clipboard = class {
  constructor(hostRef) {
  ...
  copyStarted(e) {
    ...
    this.copyRegion.emit(data || void 0);
    e.preventDefault();
  }
  /**
   * Listen to copy event and emit copy region event
  ...
  cutStarted(e) {
    ...
    this.clearRegion.emit(data || void 0);
    e.preventDefault();
  }
  async doCopy(e, data) {
...
var revogrEditStyleCss = "revogr-edit{display:block;position:absolute;background-color:#fff}revogr-edit input{height:100%;width:100%;box-sizing:border-box}revogr-edit revo-dropdown{height:100%}revogr-edit revo-dropdown.shrink fieldset legend>span{display:none}";
var RevoEdit = class {
  constructor(hostRef) {
    registerInstance(this, hostRef);
...
var OrderEditor = class {
  ...
  async dragStart(e) {
    ...
    const moveMove = (e2) => this.move(e2);
    const mouseUp = (e2) => this.endOrder(e2);
...
export {
  ...
  RevoEdit as revogr_edit,
  OrderEditor as revogr_order_editor
};
/*! Bundled license information:

@revolist/revogrid/dist/esm/text-editor-DlCRmV75.js:
  (*!
   * Built by Revolist OU ❤️
   *)

@revolist/revogrid/dist/esm/revogr-clipboard_3.entry.js:
  (*!
   * Built by Revolist OU ❤️
   *)
*/
//# sourceMappingURL=revogr-clipboard_3.entry-QKGW4KX7.js.map
