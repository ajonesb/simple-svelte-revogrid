...
// node_modules/@revolist/revogrid/dist/esm/cell-renderer-ePazz-Zt.js
var SortingSign = ({ column }) => {
  var _a;
  return h("i", { class: (_a = column === null || column === void 0 ? void 0 : column.order) !== null && _a !== void 0 ? _a : "sort-off" });
};
var PADDING_DEPTH = 10;
var RowRenderer = ({ rowClass, index, size, start, depth }, cells) => {
  const props = Object.assign({ [DATA_ROW]: index });
  return h("div", Object.assign({}, props, { class: `rgRow ${rowClass || ""}`, style: {
    height: `${size}px`,
    transform: `translateY(${start}px)`,
    paddingLeft: depth ? `${PADDING_DEPTH * depth}px` : void 0
  } }), cells);
};
...
var GroupingRowRenderer = (props) => {
  ...
  if (groupingCustomRenderer) {
    return h(
      RowRenderer,
      Object.assign({}, props, { rowClass: "groupingRow", depth }),
      h("div", { onClick: (e) => expandEvent(e, model, itemIndex) }, groupingCustomRenderer(h, Object.assign(Object.assign({}, props), {
  ...
  return h(RowRenderer, Object.assign({}, props, { rowClass: "groupingRow", depth }), hasExpand && [
    h("button", { class: { [GROUP_EXPAND_BTN]: true }, onClick: (e) => expandEvent(e, model, itemIndex) }, expandSvgIconVNode(expanded)),
    name
  ]);
};
var expandSvgIconVNode = (expanded = false) => {
  return h(
    "svg",
    { "aria-hidden": "true", style: { transform: `rotate(${!expanded ? -90 : 0}deg)` }, focusable: "false", viewBox: "0 0 448 512" },
...
function renderCell(v) {
  ...
  if (template) {
    ...
    if (v.schemaModel.column.rowDrag && isRowDragService(v.schemaModel.column.rowDrag, v.schemaModel)) {
      els.push(h(
        "span",
        { class: DRAGGABLE_CLASS, onMouseDown: (originalEvent) => {
          var _a2;
          return (_a2 = v.dragStartCell) === null || _a2 === void 0 ? void 0 : _a2.emit({
            originalEvent,
            model: v.schemaModel
          });
        } },
...
var CellRenderer = ({ renderProps, cellProps }) => {
  const render = renderCell.bind(null, renderProps);
  return h("div", Object.assign({}, cellProps, { redraw: render }), render());
};

// node_modules/@revolist/revogrid/dist/esm/revogr-data_4.entry.js
var RowHighlightPlugin = class {
  constructor() {
  ...
  render() {
    ...
    for (let rgRow of rows) {
      ...
      if (isGrouping(dataItem)) {
        const gmodel = Object.assign(Object.assign({}, rgRow), {
      ...
      for (let rgCol of cols) {
        ...
        const defaultProps = {
          ...
          style: {
            ...
            height: rowProps.size ? `${rowProps.size}px` : void 0
          }
        };
      ...
      const row = h(RowRenderer, { index: rgRow.itemIndex, rowClass, size: rgRow.size, start: rgRow.start }, cells);
...
var HeaderRenderer = (p) => {
  ...
  const dataProps = {
    ...
    onDblClick(originalEvent) {
      var _a2;
      (_a2 = p.onDblClick) === null || _a2 === void 0 ? void 0 : _a2.call(p, {
        column: p.data,
...
var RevogrHeaderComponent = class {
  ...
  onResize({ width }, index) {
    ...
    const event = this.beforeResize.emit([
      Object.assign(Object.assign({}, col), { size: width || void 0 })
    ]);
        ...
        for (let group of this.groups[i]) {
          ...
          if (groupStartIndex > -1) {
            ...
            const props = {
              ...
              onResize: (e) => {
                var _a2;
                return this.onResizeGroup((_a2 = e.changedX) !== null && _a2 !== void 0 ? _a2 : 0, groupStartIndex, groupEndIndex);
              }
            };
...
var RevogrViewportScroll = class {
  ...
  componentDidLoad() {
    this.resizeService = new GridResizeService(this.horizontalScroll, (entry) => {
      ...
      if (calculatedHeight) {
        calculatedHeight -= ((_b = (_a = this.header) === null || _a === void 0 ? void 0 : _a.clientHeight) !== null && _b !== void 0 ? _b : 0) + ((_d = (_c = this.footer) === null || _c === void 0 ? void 0 : _c.clientHeight) !== null && _d !== void 0 ? _d : 0);
      }
      els.rgRow = {
  ...
  applyOnScroll(type, coordinate, outside = false) {
    const lastScrollUpdate = () => {
      var _a;
      (_a = this.localScrollService) === null || _a === void 0 ? void 0 : _a.scroll(coordinate, type, void 0, void 0, outside);
    };
  ...
  onVerticalMouseWheel(type, delta, e) {
    ...
    (_h = this.localScrollService) === null || _h === void 0 ? void 0 : _h.scroll(pos, type, void 0, e[delta]);
  ...
  onHorizontalMouseWheel(type, delta, e) {
    ...
    (_b = this.localScrollService) === null || _b === void 0 ? void 0 : _b.scroll(pos, type, void 0, e[delta]);
    this.localScrollTimer.latestScrollUpdate(type);
  }
...
export {
  RevogrData as revogr_data,
  RevogrHeaderComponent as revogr_header,
  RevogrViewportScroll as revogr_viewport_scroll,
  VNodeToHtml as vnode_html
};
/*! Bundled license information:

@revolist/revogrid/dist/esm/cell-renderer-ePazz-Zt.js:
  (*!
   * Built by Revolist OU ❤️
   *)

@revolist/revogrid/dist/esm/revogr-data_4.entry.js:
  (*!
   * Built by Revolist OU ❤️
   *)
*/
//# sourceMappingURL=revogr-data_4.entry-UZGIUD24.js.map
