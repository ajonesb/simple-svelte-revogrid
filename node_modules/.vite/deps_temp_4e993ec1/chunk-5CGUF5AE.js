...
// node_modules/@revolist/revogrid/dist/esm/header-cell-renderer-DNIoql0s.js
...
var ResizeEvents;
(function(ResizeEvents2) {
  ResizeEvents2["start"] = "resize:start";
  ResizeEvents2["move"] = "resize:move";
  ResizeEvents2["end"] = "resize:end";
...
var ResizeDirective = class _ResizeDirective {
  ...
  handleMove(event) {
    ...
    let eventY, eventX;
    if (_ResizeDirective.isTouchEvent(event)) {
...
var ResizableElement = (props, children) => {
  const resizeEls = [];
  ...
  return h(
    "div",
    Object.assign({}, props, { ref: (e) => e && (directive === null || directive === void 0 ? void 0 : directive.set(e)) }),
    children,
    resizeEls
  );
};
var ON_COLUMN_CLICK = "columnclick";
var HeaderCellRenderer = ({ data, props, additionalData }, children) => {
...
@revolist/revogrid/dist/esm/header-cell-renderer-DNIoql0s.js:
  (*!
   * Built by Revolist OU ❤️
   *)
*/
//# sourceMappingURL=chunk-5CGUF5AE.js.map
