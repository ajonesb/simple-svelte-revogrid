...
// node_modules/@revolist/revogrid/dist/esm/revogr-filter-panel.entry.js
(function closest() {
...
var FilterPanel = class {
  ...
  onMouseDown(e) {
    ...
    if (e.target instanceof HTMLElement && isOutside && !isFilterBtn(e.target) && this.closeOnOutsideClick) {
      this.changes = void 0;
    }
  }
  ...
  render() {
    ...
    const capts = Object.assign(this.filterCaptionsInternal, this.filterCaptions);
    return h(Host, { style, ref: (el) => {
      var _a2;
      ((_a2 = this.changes) === null || _a2 === void 0 ? void 0 : _a2.autoCorrect) !== false && this.autoCorrect(el);
...
export {
  FilterPanel as revogr_filter_panel
};
...
@revolist/revogrid/dist/esm/revogr-filter-panel.entry.js:
   ...
   *)
*/
//# sourceMappingURL=revogr-filter-panel.entry-OFT2POWO.js.map
